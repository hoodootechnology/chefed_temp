...
const PrivacyPolicy = () => (
  <div>
    ...
    <p>Updated at 2020-06-01</p>
    <p>
      Chefed (“we,” “our,” or “us”) is committed to protecting your privacy.
      This Privacy Policy explains how your personal information is collected,
      used, and disclosed by Chefed.
    </p>
    <p>
      This Privacy Policy applies to our website, and its associated subdomains
      (collectively, our “Service”) alongside our application, Chefed. By
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          ...
          refers to Sweet Spot Technologies Pvt. Ltd, A-284, Vijay Singh Pathik
          Nagar, Bhilwara, Rajasthan, 311001 that is responsible for your
          information under this Privacy Policy.
        </li>
        <li>
          Country: where Chefed or the owners/founders of Chefed are based, in
          this case is IN
        </li>
        <li>
          Customer: refers to the company, organization or person that signs up
          to use the Chefed Service to manage the relationships with your
          consumers or service users.
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit Chefed and use
          the services.
        </li>
        <li>
        ...
        <li>
          Personnel: refers to those individuals who are employed by Chefed or
        ...
        <li>
          Service: refers to the service provided by Chefed as described in the
        ...
        <li>
          Website: Chefed's site, which can be accessed via this URL:
          https://www.chefed.co/
        </li>
        <li>
          You: a person or entity that is registered with Chefed to use the
          Services.
        </li>
      </ul>
    </p>
    ...
    <h1>When does Chefed use end user information from third parties?</h1>
    <p>
      Chefed will collect End User Data necessary to provide the Chefed services
      to our customers.
    </p>
    <p>
    ...
    <h1>When does Chefed use customer information from third parties?</h1>
    <p>
      ...
      becoming a Chefed customer, we receive information from a third party that
      provides automated fraud detection services to Chefed. We also
    ...
    <p>
      Chefed will collect personal information that you submit to us. We may
    ...
    <p>
      We keep your information only so long as we need it to provide Chefed to
    ...
    <p>
      ...
      information you transmit to Chefed or guarantee that your information on
    ...
    <p>
      Chefed is incorporated in IN. Information collected via our website,
    ...
    <h1>Is the information collected through the Chefed Service secure?</h1>
    <p>
    ...
    <p>
      ...
      Chefed collects depend on your relationship with Chefed. Personnel may
    ...
    <h1>Personnel</h1>
    <p>
      If you are a Chefed worker or applicant, we collect information you
    ...
    <p>
      ...
      assets of Chefed or any of its Corporate Affiliates (as defined herein),
      or that portion of Chefed or any of its Corporate Affiliates to which the
    ...
    <p>
      ...
      controls, is controlled by or is under common control with Chefed, whether
    ...
    <p>
      By using Chefed or contacting us directly, you signify your acceptance of
    ...
    <p>
      ...
      links to other websites not operated or controlled by Chefed. We are not
    ...
    <p>
      ...
      party sites. Chefed does not make any representation as to the accuracy or
    ...
    <p>
      Advertising keeps Chefed and many of the websites and services you use
    ...
    <p>
      ...
      services are advertised are not endorsements or recommendations by Chefed
      of the third party sites, goods or services. Chefed takes no
    ...
    <p>
      ...
      the website and other online services to make online advertisements more
    ...
    <h1>Cookies</h1>
    <p>
      Chefed uses "Cookies" to identify the areas of our website that you have
    ...
    <p>
      You acknowledge and agree that Chefed shall not be responsible for any
      ...
      aspect thereof. Chefed does not assume and shall not have any liability or
    ...
    <ul>
      ...
      <li>
        ...
        <br />
        <p>
          Chefed uses "Sessions" to identify the areas of our website that you
    ...
    <ul>
      <li>Via Email: hello@hoodoo.co.in</li>
      <li>Via Phone Number: 9620656264</li>
      <li>Via this Link: https://chefed.co/</li>
    </ul>
  </div>
)
